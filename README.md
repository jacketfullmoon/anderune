...
- **Ocean monsters** — anything that spawns over water becomes a 🦈 / 🐙 / 🐍 sea creature at least 20 levels above you, marked with a red glow and a ☠️. The card warns you outright. Water is detected by querying the map's own water layer at the spawn point (re-checked once it scrolls into view, since off-screen spots can't be tested).
