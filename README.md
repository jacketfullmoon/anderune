...
- **AR battles** — tap 📷 AR in any fight to put the rear camera behind it: the monster or player stands in front of the real street, drawn huge, while the camera feed is squeezed to ~104px wide and posterised to 6 colour steps per channel, so the world outside looks like game art. Your own sprite hides (you're holding the phone) and the normal Attack/Defend/Act/Run buttons work as usual. Needs https and camera permission; toggling off releases the camera, and leaving the battle always does.
