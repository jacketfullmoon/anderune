...
- **Battles** — real turn-based PvP between two phones: **Attack / Defend / Act / Run**, shown as floating circular bubbles fanned around your own health card in the bottom-right corner (the enemy's card sits diagonally opposite, top-left) — Attack opens a second ring of bubbles for your weapon choice (👊 punch — weaker but crits often, 🗡️ dagger — high crit, ⚔️ sword — hardest hit) plus your own **special attack**. The special costs **2 AP (Ander Points)**, charged by a pip meter under each fighter's health bar — every attack, defend, praise or item use adds one pip, and casting spends 2 back down, so it's repeatable all fight, not a once-and-done move. Base capacity is 2 pips; train **AP capacity** with your level-up stat points to bank more and fire off specials back to back. Hits fly in as animated emoji and the target flashes red; defending blooms a shield out of the middle of the screen; specials orbit the enemy trailing sparks before bursting. Act also has **Chat**, so you can talk mid-fight — negotiate, or just say "you're good, can I add you?". Act covers Truce (end it early, both must agree), Praise (lowers their attack), Pay 30 coins, and Use item. Lose and you forfeit 25% of your coins to the winner.
...
- **AR battles** — tap 📷 AR in any fight to put the rear camera behind it. The enemy is pinned to its real spot using the phone's compass: turn away and it slides off screen (with an arrow pointing back), turn back and it's still standing where it was. Your own controls — the floating bubble menu and bottom panel — stay exactly where they are outside AR, so the whole battle UI is consistent whether or not the camera's on. The feed is drawn ~190px wide and posterised to 10 steps per channel for a chunky-but-readable look, with threshold bloom on the highlights. Your own sprite hides (you're holding the phone). Needs https, camera permission, and motion access for the compass; without motion access the enemy just stays centred. Toggling off or leaving the battle releases the camera.
- **Battle feel** — getting hit flashes the whole screen red for an instant, and an incoming attack sends the enemy's weapon emoji rushing straight at the camera before it lands. Your own punch/dagger/sword swings in from off-frame and connects on the enemy, instead of just appearing mid-air. When you're not in AR, the arena backdrop matches the real world: it goes dark with a moon and stars at night, and the far background reflects where you actually are — open ocean near the coast, cranes and containers by the Port of LA/Long Beach, a dense skyline downtown, houses and trees in residential areas, or open parkland near a park — read live from the map's real geometry, not a fixed zone list.
- **Mining minigame** — under Quests, ⛏️ Mine a seam opens a Queens-style logic puzzle: one crown per row, column and colour, none touching even diagonally. Boards are generated from a known solution, so every one is solvable. A cracked seam pays 14–30 coins and a quarter of a stat point (four solves = a full point). Paying seams come every 15 minutes; practice puzzles in between are unlimited and free.
- **Levels and stat points** — XP scales with who you beat: an even fight is worth about 45, someone five levels above you about 120, a level 2 monster about 7. Each level needs more than the last, grants **2 stat points to spend yourself** (attack, defense, special power, negotiate, AP capacity), and throws in a point or two automatically. Negotiate raises the odds a monster accepts your truce; special power raises your special attack's damage; AP capacity raises how much Ander Points charge you can bank at once.
